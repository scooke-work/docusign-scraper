...
- **Scraper is complete & hardened**; corpus = ~16 datasets under `data/` covering the full dev API surface (minus SOAP), AI products (Agents, Iris/AI Assistant), the IAM platform, and core support. See README for the list and known-partial notes (CLM support = representative sample).
