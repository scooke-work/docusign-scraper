---
title: ': get'
source_url: https://developers.docusign.com/docs/esign-rest-api/v2/reference/envelopes/envelopedocuments/get/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:45Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/v2/reference/envelopes/envelopedocuments/get/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/v2/reference/envelopes/envelopedocuments/get/?explorer=true)

[EnvelopeDocuments](https://developers.docusign.com/docs/esign-rest-api/v2/reference/envelopes/envelopedocuments/)
...
```
/restapi/v2/accounts/{accountId}/envelopes/{envelopeId}/documents/{documentId}
```
