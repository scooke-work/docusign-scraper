...
source_url: https://developers.docusign.com/docs/esign-rest-api/v2/reference/envelopes/envelopes/getrecipientsignatureimage/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:49Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/v2/reference/envelopes/envelopes/getrecipientsignatureimage/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/v2/reference/envelopes/envelopes/getrecipientsignatureimage/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/envelopes/{envelopeId}/recipients/{recipientId}/signature_image
```
...
| Query Parameters |  |  |
| --- | --- | --- |
| include\_chrome | string | When set to **true**, indicates the chromed version of the signature image should be retrieved. |
