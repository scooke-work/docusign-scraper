---
title: ': list'
source_url: https://developers.docusign.com/docs/esign-rest-api/v2/reference/cloudstorage/cloudstorageproviders/list/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:41Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/v2/reference/cloudstorage/cloudstorageproviders/list/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/v2/reference/cloudstorage/cloudstorageproviders/list/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/users/{userId}/cloud_storage
```
