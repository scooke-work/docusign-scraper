...
source_url: https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/
...
[ConnectConfigurations](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectconfigurations/)
...
|  |  |  |
| --- | --- | --- |
| [create](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectconfigurations/create/) | [delete](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectconfigurations/delete/) | [get](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectconfigurations/get/) |
| [list](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectconfigurations/list/) | [listUsers](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectconfigurations/listusers/) | [update](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectconfigurations/update/) |

[ConnectEvents](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectevents/)
...
|  |  |  |
| --- | --- | --- |
| [delete](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectevents/delete/) | [deleteFailure](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectevents/deletefailure/) | [deleteList](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectevents/deletelist/) |
| [get](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectevents/get/) | [list](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectevents/list/) | [listFailures](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectevents/listfailures/) |
| [retryForEnvelope](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectevents/retryforenvelope/) | [retryForEnvelopes](https://developers.docusign.com/docs/esign-rest-api/v2/reference/connect/connectevents/retryforenvelopes/) |  |
