---
title: ': update'
source_url: https://developers.docusign.com/docs/esign-rest-api/v2/reference/users/userprofiles/update/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:58Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/v2/reference/users/userprofiles/update/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/v2/reference/users/userprofiles/update/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/users/{userId}/profile
```
