---
title: ': getImage'
source_url: https://developers.docusign.com/docs/esign-rest-api/v2/reference/users/usersignatures/getimage/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:59Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/v2/reference/users/usersignatures/getimage/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/v2/reference/users/usersignatures/getimage/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/users/{userId}/signatures/{signatureId}/{imageType}
```
...
| imageType \* | string | One of **signature\_image** or **initials\_image**. |
