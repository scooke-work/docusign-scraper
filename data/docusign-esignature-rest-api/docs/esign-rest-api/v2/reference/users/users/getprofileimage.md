...
source_url: https://developers.docusign.com/docs/esign-rest-api/v2/reference/users/users/getprofileimage/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:58Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/v2/reference/users/users/getprofileimage/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/v2/reference/users/users/getprofileimage/?explorer=true)
