---
title: ': deleteCaptiveRecipient'
source_url: https://developers.docusign.com/docs/esign-rest-api/v2/reference/accounts/accounts/deletecaptiverecipient/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:38Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/v2/reference/accounts/accounts/deletecaptiverecipient/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/v2/reference/accounts/accounts/deletecaptiverecipient/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/captive_recipients/{recipientPart}
```
