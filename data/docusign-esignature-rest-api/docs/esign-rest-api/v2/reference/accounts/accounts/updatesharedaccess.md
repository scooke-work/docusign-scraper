...
source_url: https://developers.docusign.com/docs/esign-rest-api/v2/reference/accounts/accounts/updatesharedaccess/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:39Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/v2/reference/accounts/accounts/updatesharedaccess/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/v2/reference/accounts/accounts/updatesharedaccess/?explorer=true)
...
| user\_ids | string | A comma-separated list of user IDs whose shared item information is being set. |
