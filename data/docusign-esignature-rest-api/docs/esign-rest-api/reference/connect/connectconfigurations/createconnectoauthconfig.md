---
title: ': createConnectOAuthConfig'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectconfigurations/createconnectoauthconfig/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:28:33Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectconfigurations/createconnectoauthconfig/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectconfigurations/createconnectoauthconfig/?explorer=true)
...
- [OAuth for Docusign Connect](https://developers.docusign.com/platform/webhooks/connect/validation-and-security/oauth-connect/)
...
```
/restapi/v2.1/accounts/{accountId}/connect/oauth
```
...
### Connect::createConnectOAuthConfig
