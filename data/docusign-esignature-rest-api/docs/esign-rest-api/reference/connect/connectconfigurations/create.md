---
title: ': create'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectconfigurations/create/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:11Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectconfigurations/create/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectconfigurations/create/?explorer=true)
...
If you want to listen for events on only one envelope, use the [eventNotification](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopes/create/#schema__envelopedefinition_eventnotification) object instead.
...
Docusign recommends using the [JSON SIM event model](https://developers.docusign.com/platform/webhooks/connect/json-sim-event-model/).
...
- For more information about Connect, see the [Docusign Connect guide](https://developers.docusign.com/platform/webhooks/connect/).
