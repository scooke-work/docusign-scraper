---
title: ': listUsers'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectconfigurations/listusers/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:12Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectconfigurations/listusers/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectconfigurations/listusers/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/connect/{connectId}/users
```
