...
You can then use
[ConnectEvents: retryForEnvelopes](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/retryforenvelopes/)
...
```
/restapi/v2.1/accounts/{accountId}/connect/failures
```
