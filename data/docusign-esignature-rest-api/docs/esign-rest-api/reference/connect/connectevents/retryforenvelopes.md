...
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/retryforenvelopes/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:28:33Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/retryforenvelopes/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/retryforenvelopes/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/connect/envelopes/retry_queue
```
