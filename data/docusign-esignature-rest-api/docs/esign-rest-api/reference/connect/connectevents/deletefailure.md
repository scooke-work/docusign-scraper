---
title: ': deleteFailure'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/deletefailure/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:12Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/deletefailure/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/deletefailure/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/connect/failures/{failureId}
```
