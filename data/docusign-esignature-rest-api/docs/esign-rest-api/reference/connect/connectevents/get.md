---
title: ': get'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/get/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:12Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/get/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/connect/connectevents/get/?explorer=true)
...
| Query Parameters |  |  |
| --- | --- | --- |
| additional\_info | string | When **true,** the response includes the `connectDebugLog` information. |
