...
This endpoint generates a new shared HMAC secret, used to sign Connect webhook notifications. The secret is associated with the account and is required to validate the integrity and authenticity of incoming Connect payloads using HMAC signatures. See [Using HMAC Security with Docusign Connect](https://developers.docusign.com/platform/webhooks/connect/hmac/) for details.
