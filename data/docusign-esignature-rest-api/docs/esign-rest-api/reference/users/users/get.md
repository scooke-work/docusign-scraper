---
title: ': get'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/users/users/get/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:34Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/users/users/get/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/users/users/get/?explorer=true)
...
| Query Parameters |  |  |
| --- | --- | --- |
| additional\_info | string | Setting this parameter has no effect in this operation. |
| email | string | Setting this parameter has no effect in this operation. |
