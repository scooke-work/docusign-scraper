---
title: ': create'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/users/usersignatures/create/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:34Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/users/usersignatures/create/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/users/usersignatures/create/?explorer=true)
