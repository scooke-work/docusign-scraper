---
title: ': update'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/users/usersignatures/update/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:34Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/users/usersignatures/update/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/users/usersignatures/update/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/users/{userId}/signatures/{signatureId}
```
