---
title: ': update'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/users/userprofiles/update/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:33Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/users/userprofiles/update/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/users/userprofiles/update/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/users/{userId}/profile
```
