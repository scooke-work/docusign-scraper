---
title: ': getBulkSendBatches'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/bulkenvelopes/bulksend/getbulksendbatches/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:10Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/bulkenvelopes/bulksend/getbulksendbatches/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/bulkenvelopes/bulksend/getbulksendbatches/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/bulk_send_batch
```
...
| Query Parameters |  |  |
| --- | --- | --- |
| batch\_ids | string | A comma-separated list of batch IDs to query. |
| count | string | The maximum number of results to return.  Use `start_position` to specify the number of results to skip.  Valid values: `1` to `100`  Default: `100` |
| from\_date | string | Required. The start date for a date range in UTC DateTime format. |
...
### BulkEnvelopes::getBulkSendBatches
