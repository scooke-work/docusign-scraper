...
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/accounts/identityverifications/
...
| Method | Description |
| --- | --- |
| [list](https://developers.docusign.com/docs/esign-rest-api/reference/accounts/identityverifications/list/) | GET  ```  /restapi/v2.1/accounts/{accountId}/identity_verification ```  Retrieves the Identity Verification workflows available to an account. |
