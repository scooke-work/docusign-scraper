---
title: ': createUserAuthorization'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/accounts/authorizations/createuserauthorization/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:28:29Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/accounts/authorizations/createuserauthorization/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/accounts/authorizations/createuserauthorization/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/users/{userId}/authorization
```
...
### Accounts::createUserAuthorization
