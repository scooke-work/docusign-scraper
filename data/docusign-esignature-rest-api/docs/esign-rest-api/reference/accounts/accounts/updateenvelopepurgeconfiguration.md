---
title: ': updateEnvelopePurgeConfiguration'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/accounts/accounts/updateenvelopepurgeconfiguration/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:28:27Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/accounts/accounts/updateenvelopepurgeconfiguration/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/accounts/accounts/updateenvelopepurgeconfiguration/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/settings/envelope_purge_configuration
```
...
### Accounts::updateEnvelopePurgeConfiguration
