---
title: ': updateSharedAccess'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/accounts/accounts/updatesharedaccess/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:28:27Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/accounts/accounts/updatesharedaccess/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/accounts/accounts/updatesharedaccess/?explorer=true)
...
| Query Parameters |  |  |
| --- | --- | --- |
| item\_type | string | Specifies the type of shared item being set:   - `envelopes`: Set envelope sharing between users. - `templates`: Set information about template sharing among users and groups. - `folders`: Get information about folder sharing among users and groups. |
| preserve\_existing\_shared\_access | string | When **true,** preserve the existing shared access settings. |
| user\_ids | string | A comma-separated list of IDs for users whose shared item access is being set. |
