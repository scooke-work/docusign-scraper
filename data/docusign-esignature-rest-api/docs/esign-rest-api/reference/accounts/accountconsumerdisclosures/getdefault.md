---
title: ': getDefault'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/accounts/accountconsumerdisclosures/getdefault/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:28:25Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/accounts/accountconsumerdisclosures/getdefault/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/accounts/accountconsumerdisclosures/getdefault/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/consumer_disclosure
```
