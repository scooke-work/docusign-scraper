---
title: ': delete'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/templates/templatelocks/delete/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:30Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/templates/templatelocks/delete/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/templates/templatelocks/delete/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/templates/{templateId}/lock
```
