---
title: ': create'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/templates/templatedocumentresponsivehtmlpreview/create/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:29Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/templates/templatedocumentresponsivehtmlpreview/create/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/templates/templatedocumentresponsivehtmlpreview/create/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/templates/{templateId}/documents/{documentId}/responsive_html_preview
```
