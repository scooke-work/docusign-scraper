---
title: ': createEdit'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/templates/templateviews/createedit/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:32Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/templates/templateviews/createedit/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/templates/templateviews/createedit/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/templates/{templateId}/views/edit
```
