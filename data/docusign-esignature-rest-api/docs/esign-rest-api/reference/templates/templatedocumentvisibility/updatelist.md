---
title: ': updateList'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/templates/templatedocumentvisibility/updatelist/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:30Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/templates/templatedocumentvisibility/updatelist/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/templates/templatedocumentvisibility/updatelist/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/templates/{templateId}/recipients/document_visibility
```
