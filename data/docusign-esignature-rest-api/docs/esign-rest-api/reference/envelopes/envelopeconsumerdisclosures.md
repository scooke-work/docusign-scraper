---
title: EnvelopeConsumerDisclosures Resource
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeconsumerdisclosures/
...
# EnvelopeConsumerDisclosures Resource
...
| Method | Description |
| --- | --- |
| [get](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeconsumerdisclosures/get/) | GET  ```  /restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/recipients/{recipientId}/consumer_disclosure/{langCode} ```  Gets the Electronic Record and Signature Disclosure for a specific envelope recipient. |
| [getDefault](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeconsumerdisclosures/getdefault/) | GET  ```  /restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/recipients/{recipientId}/consumer_disclosure ```  Gets the default Electronic Record and Signature Disclosure for an envelope. |
