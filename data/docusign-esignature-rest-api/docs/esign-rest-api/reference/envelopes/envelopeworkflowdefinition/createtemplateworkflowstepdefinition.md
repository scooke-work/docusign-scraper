---
title: ': createTemplateWorkflowStepDefinition'
...
```
/restapi/v2.1/accounts/{accountId}/templates/{templateId}/workflow/steps
```
...
### Envelopes::createTemplateWorkflowStepDefinition
