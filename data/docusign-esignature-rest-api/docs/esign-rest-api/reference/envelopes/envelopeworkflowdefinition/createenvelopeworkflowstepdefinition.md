---
title: ': createEnvelopeWorkflowStepDefinition'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeworkflowdefinition/createenvelopeworkflowstepdefinition/
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/workflow/steps
```
...
### Envelopes::createEnvelopeWorkflowStepDefinition
