---
title: ': createHistoricalEnvelopePublishTransaction'
...
You can publish up to a maximum of 9999 envelopes per hour.
...
```
/restapi/v2.1/accounts/{accountId}/connect/envelopes/publish/historical
```
...
### Envelopes::createHistoricalEnvelopePublishTransaction
