---
title: ': get'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/comments/get/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:14Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/comments/get/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/comments/get/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/comments/transcript
```
...
| Query Parameters |  |  |
| --- | --- | --- |
| encoding | string | (Optional) The encoding to use for the file. |
