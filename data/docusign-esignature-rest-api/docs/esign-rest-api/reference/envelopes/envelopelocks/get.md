---
title: ': get'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopelocks/get/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:18Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopelocks/get/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopelocks/get/?explorer=true)
...
The `X-DocuSign-Edit` header is included in the response. If the envelope referenced in the request is not locked, this method returns a 404 error including the error code EDIT\_LOCK\_ENVELOPE\_NOT\_LOCKED.
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/lock
```
