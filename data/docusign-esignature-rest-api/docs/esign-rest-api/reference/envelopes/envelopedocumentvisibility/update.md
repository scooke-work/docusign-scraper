---
title: ': update'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopedocumentvisibility/update/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:17Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopedocumentvisibility/update/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopedocumentvisibility/update/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/recipients/{recipientId}/document_visibility
```
