---
title: ': list'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopedocuments/list/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:02Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopedocuments/list/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopedocuments/list/?explorer=true)
...
| include\_agreement\_type | string |  |
| include\_docgen\_formfields | string | Reserved for Docusign. |
| include\_is\_edited | string |  |
| include\_metadata | string | When **true,** the response includes metadata that indicates which properties the sender can edit. |
| include\_tabs | string | Reserved for Docusign. |
| recipient\_id | string | Allows the sender to retrieve the documents as one of the recipients that they control. The `documents_by_userid` parameter must be set to **false** for this to work. |
