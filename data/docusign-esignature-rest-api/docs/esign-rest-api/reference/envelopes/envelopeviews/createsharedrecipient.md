...
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeviews/createsharedrecipient/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:28:44Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeviews/createsharedrecipient/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeviews/createsharedrecipient/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/views/shared
```
