...
- Using the reference documentation below, create a settings object that accomplishes your UI goals. Note that the `settings` object includes multiple objects and subobjects for various UI settings.
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/views/sender
```
