---
title: ': get'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeformdata/get/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:28:23Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeformdata/get/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopeformdata/get/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/form_data
```
