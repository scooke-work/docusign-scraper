---
title: ': create'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopetransferrules/create/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:22Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopetransferrules/create/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopetransferrules/create/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/transfer_rules
```
