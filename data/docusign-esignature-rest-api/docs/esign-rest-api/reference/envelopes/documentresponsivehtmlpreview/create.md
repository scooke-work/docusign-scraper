---
title: ': create'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/documentresponsivehtmlpreview/create/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:14Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/documentresponsivehtmlpreview/create/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/documentresponsivehtmlpreview/create/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/documents/{documentId}/responsive_html_preview
```
