...
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/comments/
...
| Method | Description |
| --- | --- |
| [get](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/comments/get/) | GET  ```  /restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/comments/transcript ```  Gets a PDF transcript of all of the comments in an envelope. |
