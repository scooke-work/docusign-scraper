...
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopetemplates/applytodocument/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:28:43Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopetemplates/applytodocument/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/envelopes/envelopetemplates/applytodocument/?explorer=true)
...
```
/restapi/v2.1/accounts/{accountId}/envelopes/{envelopeId}/documents/{documentId}/templates
```
