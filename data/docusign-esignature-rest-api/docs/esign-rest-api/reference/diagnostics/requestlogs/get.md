---
title: ': get'
source_url: https://developers.docusign.com/docs/esign-rest-api/reference/diagnostics/requestlogs/get/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T21:10:13Z'
---

[API Reference](https://developers.docusign.com/docs/esign-rest-api/reference/diagnostics/requestlogs/get/)[API Explorer](https://developers.docusign.com/docs/esign-rest-api/reference/diagnostics/requestlogs/get/?explorer=true)
...
```
/restapi/v2.1/diagnostics/request_logs/{requestLogId}
```
