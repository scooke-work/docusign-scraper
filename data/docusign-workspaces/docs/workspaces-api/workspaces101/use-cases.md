---
title: Workspaces API use cases
source_url: https://developers.docusign.com/docs/workspaces-api/workspaces101/use-cases/
...
# Workspaces API use cases

You can use Workspaces API to help manage complex agreement processes from a central hub and control which information is provided to each participant.
