---
title: ': getWorkspaceAssignableRoles'
source_url: https://developers.docusign.com/docs/workspaces-api/reference/workspaces/workspaces/getworkspaceassignableroles/
...
[Required authentication scopes](https://developers.docusign.com/docs/workspaces-api/auth/): `dtr.company.read`
...
| start\_position | integer | The index position within the total result set from which to start returning values. The default value is 0 |
