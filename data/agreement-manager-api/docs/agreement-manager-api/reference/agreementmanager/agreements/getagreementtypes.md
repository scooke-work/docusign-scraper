---
title: ': getAgreementTypes'
source_url: https://developers.docusign.com/docs/agreement-manager-api/reference/agreementmanager/agreements/getagreementtypes/
...
```
/v1/accounts/{accountId}/agreement-types
```
