---
title: Roles Category
source_url: https://developers.docusign.com/docs/rooms-api/reference/roles/
...
|  |  |  |
| --- | --- | --- |
| [CreateRole](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/createrole/) | [DeleteRole](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/deleterole/) | [GetRole](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/getrole/) |
| [GetRoles](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/getroles/) | [UpdateRole](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/updaterole/) |  |
