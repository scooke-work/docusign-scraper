---
title: ': GetAssignableRoles'
source_url: https://developers.docusign.com/docs/rooms-api/reference/rooms/rooms/getassignableroles/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T22:33:04Z'
---

[API Reference](https://developers.docusign.com/docs/rooms-api/reference/rooms/rooms/getassignableroles/)[API Explorer](https://developers.docusign.com/docs/rooms-api/reference/rooms/rooms/getassignableroles/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/rooms/{roomId}/assignable_roles
```
