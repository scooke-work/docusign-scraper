---
title: ': PutRoomUser'
source_url: https://developers.docusign.com/docs/rooms-api/reference/rooms/rooms/putroomuser/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T22:33:04Z'
---

[API Reference](https://developers.docusign.com/docs/rooms-api/reference/rooms/rooms/putroomuser/)[API Explorer](https://developers.docusign.com/docs/rooms-api/reference/rooms/rooms/putroomuser/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/rooms/{roomId}/users/{userId}
```
