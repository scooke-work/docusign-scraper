---
title: Roles Resource
source_url: https://developers.docusign.com/docs/rooms-api/reference/roles/roles/
...
| Method | Description |
| --- | --- |
| [CreateRole](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/createrole/) | POST  ```  /restapi/v2/accounts/{accountId}/roles ```  Creates a role. |
| [DeleteRole](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/deleterole/) | DEL  ```  /restapi/v2/accounts/{accountId}/roles/{roleId} ```  Deletes a role. |
| [GetRole](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/getrole/) | GET  ```  /restapi/v2/accounts/{accountId}/roles/{roleId} ```  Gets a role. |
| [GetRoles](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/getroles/) | GET  ```  /restapi/v2/accounts/{accountId}/roles ```  Gets roles. |
| [UpdateRole](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/updaterole/) | PUT  ```  /restapi/v2/accounts/{accountId}/roles/{roleId} ```  Updates a role. |
