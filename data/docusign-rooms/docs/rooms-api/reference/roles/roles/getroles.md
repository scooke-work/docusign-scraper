---
title: ': GetRoles'
source_url: https://developers.docusign.com/docs/rooms-api/reference/roles/roles/getroles/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T22:33:03Z'
---

[API Reference](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/getroles/)[API Explorer](https://developers.docusign.com/docs/rooms-api/reference/roles/roles/getroles/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/roles
```
...
| Query Parameters |  |  |
| --- | --- | --- |
| onlyAssignable | boolean | This parameter is deprecated. Use `filterContext` instead. Note that `filterContext=AssignableRolesBasedOnCompanyPermissions` is equivalent to `onlyAssignable=true`. |
...
| startPosition | integer | The starting zero-based index position of the result set. The default value is 0. |
