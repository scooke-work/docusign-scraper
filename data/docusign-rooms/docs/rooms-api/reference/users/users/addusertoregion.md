---
title: ': AddUserToRegion'
source_url: https://developers.docusign.com/docs/rooms-api/reference/users/users/addusertoregion/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T22:33:08Z'
---

[API Reference](https://developers.docusign.com/docs/rooms-api/reference/users/users/addusertoregion/)[API Explorer](https://developers.docusign.com/docs/rooms-api/reference/users/users/addusertoregion/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/users/{userId}/add_to_region
```
