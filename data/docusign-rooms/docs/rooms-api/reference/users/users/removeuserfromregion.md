---
title: ': RemoveUserFromRegion'
source_url: https://developers.docusign.com/docs/rooms-api/reference/users/users/removeuserfromregion/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T22:33:08Z'
---

[API Reference](https://developers.docusign.com/docs/rooms-api/reference/users/users/removeuserfromregion/)[API Explorer](https://developers.docusign.com/docs/rooms-api/reference/users/users/removeuserfromregion/?explorer=true)
...
```
/restapi/v2/accounts/{accountId}/users/{userId}/remove_from_region
```
