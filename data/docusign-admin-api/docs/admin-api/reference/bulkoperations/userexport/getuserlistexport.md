---
title: ': getUserListExport'
source_url: https://developers.docusign.com/docs/admin-api/reference/bulkoperations/userexport/getuserlistexport/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:12:06Z'
---

[API Reference](https://developers.docusign.com/docs/admin-api/reference/bulkoperations/userexport/getuserlistexport/)[API Explorer](https://developers.docusign.com/docs/admin-api/reference/bulkoperations/userexport/getuserlistexport/?explorer=true)
...
- See [how this endpoint is used to bulk export user data](https://developers.docusign.com/docs/admin-api/how-to/bulk-export-users/).
...
```
/Management/v2/organizations/{organizationId}/exports/user_list/{exportId}
```
...
### BulkOperations::getUserListExport
