---
title: ': createUserListExport'
source_url: https://developers.docusign.com/docs/admin-api/reference/bulkoperations/userexport/createuserlistexport/
site: developers.docusign.com
breadcrumb: []
scraped_at: '2026-06-18T20:12:06Z'
---

[API Reference](https://developers.docusign.com/docs/admin-api/reference/bulkoperations/userexport/createuserlistexport/)[API Explorer](https://developers.docusign.com/docs/admin-api/reference/bulkoperations/userexport/createuserlistexport/?explorer=true)
...
```
/Management/v2/organizations/{organizationId}/exports/user_list
```
