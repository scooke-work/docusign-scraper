---
title: Workflow configuration for file output scenarios (beta)
source_url: https://developers.docusign.com/extension-apps/extension-apps-101/supported-extensions/file-output-system-of-record/workflow-configuration/
...
# Workflow configuration for file output scenarios (beta)

Expand each section below to see the steps in an example workflow that implements a specific combination of options for the [file output destination record identifier](https://developers.docusign.com/extension-apps/extension-apps-101/supported-extensions/file-output-system-of-record/identify-destination-records/) and the [file source](https://developers.docusign.com/extension-apps/extension-apps-101/supported-extensions/file-output-system-of-record/identify-file-source/).
